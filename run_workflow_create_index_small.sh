...
python app/workflow.py create-embeddings --chunk-size 0.0125
python app/workflow.py update-es-index --chunk-size 0.0125
curl -X POST "http://127.0.0.1:8000/api/rag" -H "Content-Type: application/json" -d '{"question": "Wie hoch darf ein Gebäude in Bauklasse I gemäß Artikel IV in Wien sein?", "model":"jinaai/jina-embeddings-v2-base-de", "spacy_model":"de_core_news_lg", "chunk_size_in_kb":0.0125}'
python app/workflow.py create-embeddings --chunk-size 0.025
python app/workflow.py update-es-index --chunk-size 0.025
curl -X POST "http://127.0.0.1:8000/api/rag" -H "Content-Type: application/json" -d '{"question": "Wie hoch darf ein Gebäude in Bauklasse I gemäß Artikel IV in Wien sein?", "model":"jinaai/jina-embeddings-v2-base-de", "spacy_model":"de_core_news_lg", "chunk_size_in_kb":0.025}'
...
python app/workflow.py create-embeddings --chunk-size 0.0125 --model sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2
python app/workflow.py update-es-index --chunk-size 0.0125 --model sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2
curl -X POST "http://127.0.0.1:8000/api/rag" -H "Content-Type: application/json" -d '{"question": "Wie hoch darf ein Gebäude in Bauklasse I gemäß Artikel IV in Wien sein?", "model":"sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2", "spacy_model":"de_core_news_lg", "chunk_size_in_kb":0.0125}'
python app/workflow.py create-embeddings --chunk-size 0.025 --model sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2
python app/workflow.py update-es-index --chunk-size 0.025 --model sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2
curl -X POST "http://127.0.0.1:8000/api/rag" -H "Content-Type: application/json" -d '{"question": "Wie hoch darf ein Gebäude in Bauklasse I gemäß Artikel IV in Wien sein?", "model":"sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2", "spacy_model":"de_core_news_lg", "chunk_size_in_kb":0.025}'
