python workflow.py create-embeddings --chunk-size 4
python workflow.py update-es-index --chunk-size 4
...
python workflow.py create-embeddings --chunk-size 8
python workflow.py update-es-index --chunk-size 8
...
python workflow.py create-embeddings --chunk-size 16
python workflow.py update-es-index --chunk-size 16
...
python workflow.py create-embeddings --chunk-size 32
python workflow.py update-es-index --chunk-size 32
...
python workflow.py create-embeddings --chunk-size 64
python workflow.py update-es-index --chunk-size 64
...
python workflow.py create-embeddings --chunk-size 128
python workflow.py update-es-index --chunk-size 128
